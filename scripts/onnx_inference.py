...
if __name__ == '__main__':
    ...
    # save_path = '../inference'  # 测试yolov7-tiny.onnx
    save_path = '../Motherboard'
    for img_path in os.listdir(opt.imgs_path):
        ...
        # a.save(save_path + '/' + 'pre_img' + '/' + img_path)  # 结果保存路径
        a.save(save_path + '/' + 'pre_img_noINF' + '/' + img_path)
        print('*' * 50)
    print('predict images saved in:', save_path + '/' + 'pre_img_noINF')
